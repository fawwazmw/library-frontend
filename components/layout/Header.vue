                                ...
                                <template #content="{ close }">
                                    <ul class="w-[230px] !py-0 font-semibold text-dark dark:text-white-dark dark:text-white-light/90">
                                        <li>
                                            <div class="flex items-center px-4 py-4">
                                                ...
                                                <div class="truncate ltr:pl-4 rtl:pr-4">
                                                    <h4 class="text-base">
                                                        John Doe<span class="rounded bg-success-light px-1 text-xs text-success ltr:ml-2 rtl:ml-2">User</span>
                                                    </h4>
                                                    <!-- <a
                                        ...
                                        <li class="border-t border-white-light dark:border-white-light/10">
                                            <NuxtLink to="/auth/cover-login" class="!py-3 text-danger" @click.prevent="handleLogout">
...
<script lang="ts" setup>
    ...
    import { useCookie } from '#app'; // Menggunakan cookie untuk menyimpan tokenmenggunakan cookie
    ...
    const tokenCookie = useCookie('auth_token'); // Inisialisasi cookie token
    ...
    const handleLogout = async () => {
        ...
        tokenCookie.value = null; // Hapus token dari cookie
        router.push('/auth/cover-login'); // Redirect ke halaman login
    };
